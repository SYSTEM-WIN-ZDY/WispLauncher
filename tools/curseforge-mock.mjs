...
const fileId = 200001
const fileBody = Buffer.from(' Wisp CurseForge local fixture\n')
...
const file = {
	...
	fileName: 'wisp-local-fixture-1.0.0.jar',
	releaseType: 1,
	fileStatus: 4,
	hashes: [],
	fileDate: now,
	...
	downloadUrl: `http://${host}:${port}/files/wisp-local-fixture-1.0.0.jar`,
...
const project = {
	id: projectId,
	gameId: 432,
	name: ' Wisp Local Fixture',
	slug: 'wisp-local-fixture',
	links: {
...
const server = createServer((request, response) => {
	...
	if (path === '/files/wisp-local-fixture-1.0.0.jar') {
