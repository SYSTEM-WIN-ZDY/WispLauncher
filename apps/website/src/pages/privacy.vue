...
const seoTitle = computed(() =>
	isChinese.value ? '隐私政策 -WispLauncher' : 'Privacy Policy -WispLauncher',
)
const seoDescription = computed(() =>
	isChinese.value
		? '了解WispLauncher 官方网站和桌面应用如何处理数据。'
		: 'Learn how the WispLauncher official website and desktop application handle data.',
)
...
useSeoMeta({
	...
	ogType: 'website',
	ogUrl: 'https://github.com/SYSTEM-WIN-ZDY/WispLauncher',
	robots: 'index, follow',
})

useHead({
	link: [{ rel: 'canonical', href: 'https://github.com/SYSTEM-WIN-ZDY/WispLauncher' }],
})
</script>
...
<template>
	<LegalDocument
		...
		eyebrow="隐私政策"
		title="隐私政策"
		description="本政策说明WispLauncher 官方网站和桌面应用处理数据的方式，以及第三方服务可能接收的信息。"
		updated-at="2026 年 8 月 14 日"
	>
		<h2>1. 适用范围</h2>
		<p>
			本政策适用于 WispLauncher 官方网站（GitHub 仓库页）和WispLauncher
		...
		<p>
			如有隐私问题或发现安全风险，请通过
			<a href="https://github.com/SYSTEM-WIN-ZDY/WispLauncher/issues" target="_blank" rel="noopener"
				>GitHub Issues</a
			>
	...
	<LegalDocument
		...
		description="This policy explains how the WispLauncher official website and desktop application handle data, and what information third-party services may receive."
		updated-at="August 14, 2026"
	>
		<h2>1. Scope</h2>
		<p>
			This policy applies to the WispLauncher official website (GitHub repository) and the WispLauncher desktop
