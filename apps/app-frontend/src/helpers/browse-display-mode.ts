...
const BROWSE_CONTENT_DISPLAY_MODE_STORAGE_KEY = 'wisp-browse-content-display-mode'
const BROWSE_CONTENT_PROJECT_TYPE_STORAGE_KEY = 'wisp-browse-content-project-type'
