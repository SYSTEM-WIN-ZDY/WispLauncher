...
const messages = defineMessages({
	...
	description: {
		...
		defaultMessage: 'Choose how aggressively Wisp should update content in this instance.',
	},
	...
	customDescription: {
		...
		defaultMessage:
			'Fix exact versions for selected content and let Wisp solve the remaining dependency graph.',
	},
	...
	searchLimitBody: {
		...
		defaultMessage:
			"Wisp couldn't find a solution within the search limit. Try relaxing one of your custom choices.",
	},
	conflictTitle: {
