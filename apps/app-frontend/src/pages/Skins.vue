...
const messages = defineMessages({
	...
	signInDescription: {
		...
		defaultMessage:
			'Please sign into your Minecraft account to use the skin management features of WispLauncher.',
	},
	signInButton: {
...
<template>
	...
	>
		...
		>
			<img
				src="@/assets/wisp.png"
				:alt="formatMessage(messages.wispAlt)"
