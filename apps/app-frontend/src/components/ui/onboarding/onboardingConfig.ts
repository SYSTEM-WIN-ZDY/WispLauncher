...
export const onboardingMessages = defineMessages({
	...
	translationTitle: {
		...
		defaultMessage: 'Translation, the Wisp way',
	},
	...
	updatesDescription: {
		...
		defaultMessage: 'Choose when Wisp checks for updates and whether it installs them for you.',
	},
	...
	mascotAlt: { id: 'app.onboarding.mascot-alt', defaultMessage: 'Wisp guide' },
})
