	...
	<Transition name="splash-fade" @after-leave="onAfterLeave">
		<div v-if="!doneLoading" class="fixed inset-0 z-[10000] dark">
			<div class="absolute h-screen w-full flex flex-col justify-center items-center gap-4 z-[9998]" data-tauri-drag-region>
				<img class="app-logo" src="@/assets/allay.gif" alt="WispLauncher" />
...
.app-logo {
	...
	object-fit: contain;
	filter: drop-shadow(0 0 2rem rgba(31, 104, 192, 0.35));
}
...
.gradient-bg {
	...
	width: 100vw;
	background:
		linear-gradient(180deg, rgba(31, 104, 192, 0.24) 0%, rgba(17, 35, 64, 0.56) 97.29%),
