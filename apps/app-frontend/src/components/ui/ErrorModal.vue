...
const messages = defineMessages({
	...
	stateTitle: {
		...
		defaultMessage: 'Error initializing WispLauncher',
	},
	networkIssues: { id: 'app.error.network-issues', defaultMessage: 'Network issues' },
	networkDescription: {
		id: 'app.error.network-description',
		defaultMessage:
			'WispLauncher had trouble connecting to Microsoft services. This is often caused by a poor connection. Try again, and use our support article if the issue persists.',
	},
	hostsDescription: {
	...
	permissionsDescription: {
		...
		defaultMessage:
			'WispLauncher cannot write to the selected directory. Adjust its permissions and try again, or cancel the directory change.',
	},
	...
	directoryDescription: {
		...
		defaultMessage:
			'WispLauncher cannot migrate to the selected directory. Contact support for help or cancel the directory change.',
	},
	retryDirectory: {
	...
	stateDescription: {
		...
		defaultMessage:
			'WispLauncher failed to load correctly. A file may be corrupted or an essential file may be missing.',
	},
	stateFixIntro: {
	...
	loaderDescription: {
		...
		defaultMessage: 'WispLauncher could not find a loader version for this instance.',
	},
	loaderFix: {
...
const supportLink = ref(WispBrandConfig.supportUrl)
const metadata = ref({})
...
defineExpose({
	async show(errorVal, context, canClose = true, source = null) {
		...
		if (errorVal.message && errorVal.message.includes('Minecraft authentication error:')) {
			...
			supportLink.value = WispBrandConfig.supportUrl
				...
				<template v-if="errorType === 'minecraft_auth'">
					<template v-if="metadata.network">
						...
						<p>
							...
							<a :href="WispBrandConfig.supportUrl">
