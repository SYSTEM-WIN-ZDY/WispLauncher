...
import blueBall from '@/assets/wisp-balls/blueball.png'
import cyanBall from '@/assets/wisp-balls/cyanball.png'
import pinkBall from '@/assets/wisp-balls/pinkball.png'
import redBall from '@/assets/wisp-balls/redball.png'
import superBall from '@/assets/wisp-balls/superball.png'
import yellowBall from '@/assets/wisp-balls/yellowball.png'
...
const messages = defineMessages({
	title: { id: 'app.settings.about.game.title', defaultMessage: 'Wisp merge' },
	...
	gameOver: { id: 'app.settings.about.game.game-over', defaultMessage: 'The wisps got stranded!' },
	completed: { id: 'app.settings.about.game.completed', defaultMessage: 'Rainbow wisp!' },
	...
	tideHint: {
		...
		defaultMessage: 'The tide is falling — keep your wisps underwater!',
	},
	tapToDrop: {
		id: 'app.settings.about.game.tap-to-drop',
		defaultMessage: 'Click to drop a pink wisp',
	},
...
const WISP_MERGE_BEST_STORAGE_KEY = 'wisp-merge-best-score'
...
function readBestScore() {
	const raw = localStorage.getItem(WISP_MERGE_BEST_STORAGE_KEY)
...
function recordScore() {
	if (score.value > bestScore.value) {
		...
		localStorage.setItem(WISP_MERGE_BEST_STORAGE_KEY, String(score.value))
	}
}
...
function draw() {
	...
	context.restore()
	for (const piece of pieces) drawWisp(piece)
