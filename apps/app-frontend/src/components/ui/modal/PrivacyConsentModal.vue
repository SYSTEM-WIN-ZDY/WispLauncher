...
const messages = defineMessages({
	...
	intro: {
		...
		defaultMessage:
			'Choose what Wisp may send or display. Nothing is sent until you confirm these choices.',
	},
	telemetry: {
		...
		<template #actions>
			<div class="flex items-center justify-between gap-4">
				<ButtonStyled type="transparent">
					<button type="button" :disabled="saving" @click="openUrl(WispBrandConfig.privacyUrl)">
						<ExternalIcon />
