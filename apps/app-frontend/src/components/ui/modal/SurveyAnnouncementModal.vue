...
const DISMISSAL_KEY = 'wisp-survey-promotion-dismissed'
const LAUNCHED_BEFORE_KEY = 'wisp-launcher-opened-before'
...
const messages = defineMessages({
	...
	intro: {
		...
		defaultMessage:
			'To help us improve WispLauncher, we have prepared a short survey and would love to hear your feedback.',
	},
	reward: {
...
function fillOutSurvey() {
	dismiss()
	modal.value?.hide()
	openUrl(WispBrandConfig.surveyUrl)
}
