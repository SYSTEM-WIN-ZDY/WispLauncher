...
const DISMISSAL_KEY = 'wisp-community-announcement-video-promotion-dismissed'
...
const messages = defineMessages({
	...
	response: {
		...
		defaultMessage:
			'Since WispLauncher was promoted on video platforms, we have received far more love and attention than we expected, along with many thoughtful suggestions and high-quality reports.',
	},
	thanks: {
	...
	feedbackSuffix: {
		...
		defaultMessage: '. We look forward to improving WispLauncher together!',
	},
})
	...
	>
		<div class="flex flex-col gap-4 text-primary">
			...
			<p class="m-0 leading-relaxed">
				...
				}}<span class="font-semibold text-contrast">{ WispBrandConfig.qqGroupNumber }}</span
