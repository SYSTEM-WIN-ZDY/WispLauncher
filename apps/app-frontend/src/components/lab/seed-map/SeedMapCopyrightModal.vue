...
const messages = defineMessages({
	...
	engineBody: {
		...
		defaultMessage:
			'Biome, terrain, spawn, and structure data is generated locally with cubiomes, Copyright (c) 2020 Cubitect, provided under the MIT License, together with the Wisp native integration.',
	},
	viewCubiomes: {
