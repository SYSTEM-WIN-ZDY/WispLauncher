#ifndef WISP_CUBIOMES_BRIDGE_H
#define WISP_CUBIOMES_BRIDGE_H

#include <stddef.h>
#include <stdint.h>

typedef struct WispSeedMapFeature {
	int32_t x;
	int32_t z;
	uint32_t kind;
	uint8_t approximate;
...
/*
 * Maps an Wisp version code (major * 10000 + minor * 100 + patch) to the
