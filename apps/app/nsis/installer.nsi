...
!define WISP_BACKGROUND 16181C
!define WISP_SURFACE 1D1F23
!define WISP_RAISED 27292E
!define WISP_CONTROL 34363C
!define WISP_BORDER 42444A
!define WISP_TEXT FFFFFF
!define WISP_TEXT_MUTED B0BAC5
!define WISP_TEXT_SECONDARY 96A2B0
!define WISP_BRAND F472B6
!define WISP_SUCCESS 1BD96A
!define WISP_ERROR FF496E

!define MUI_BGCOLOR ${WISP_BACKGROUND}
!define MUI_TEXTCOLOR ${WISP_TEXT}
!define MUI_INSTFILESPAGE_COLORS "${WISP_TEXT} ${WISP_BACKGROUND}"
...
!define MUI_CUSTOMFUNCTION_GUIINIT ApplyWispTheme
!define MUI_CUSTOMFUNCTION_UNGUIINIT un.ApplyWispTheme
...
!macro WispStyleControl CONTROL FOREGROUND BACKGROUND
...
Function PageReinstall
  ...
  ${Else}
    ...
    SetCtlColors $R4 ${WISP_TEXT} ${WISP_BACKGROUND}

    ${NSD_CreateLabel} 0 0 100% 24u $R1
    Pop $R1
    SetCtlColors $R1 ${WISP_TEXT_MUTED} ${WISP_BACKGROUND}
    SendMessage $R1 ${WM_SETFONT} $InstallerBodyFont 1

    ${NSD_CreateRadioButton} 30u 50u -30u 8u $R2
    Pop $R2
    !insertmacro WispStyleControl $R2 ${WISP_TEXT} ${WISP_BACKGROUND}
    ${NSD_OnClick} $R2 PageReinstallUpdateSelection

    ${NSD_CreateRadioButton} 30u 70u -30u 8u $R3
    Pop $R3
    !insertmacro WispStyleControl $R3 ${WISP_TEXT} ${WISP_BACKGROUND}
...
Function ApplyWispTheme
  ...
  SetCtlColors $HWNDPARENT ${WISP_TEXT} ${WISP_BACKGROUND}
  GetDlgItem $0 $HWNDPARENT 1
  !insertmacro WispStyleControl $0 ${WISP_TEXT} ${WISP_CONTROL}
  GetDlgItem $0 $HWNDPARENT 2
  !insertmacro WispStyleControl $0 ${WISP_TEXT} ${WISP_CONTROL}
  GetDlgItem $0 $HWNDPARENT 3
  !insertmacro WispStyleControl $0 ${WISP_TEXT} ${WISP_CONTROL}
  GetDlgItem $0 $HWNDPARENT 1028
  !insertmacro WispStyleControl $0 ${WISP_TEXT_SECONDARY} ${WISP_BACKGROUND}
FunctionEnd

Function StyleCurrentPage
  FindWindow $0 "#32770" "" $HWNDPARENT
  SetCtlColors $0 ${WISP_TEXT} ${WISP_BACKGROUND}
  SendMessage $0 ${WM_SETFONT} $InstallerBodyFont 1

  GetDlgItem $1 $0 1200
  SetCtlColors $1 ${WISP_TEXT} ${WISP_BACKGROUND}
  SendMessage $1 ${WM_SETFONT} $InstallerTitleFont 1
  GetDlgItem $1 $0 1201
  SetCtlColors $1 ${WISP_TEXT_MUTED} ${WISP_BACKGROUND}
  SendMessage $1 ${WM_SETFONT} $InstallerBodyFont 1
  GetDlgItem $1 $0 1004
  !insertmacro WispStyleControl $1 ${WISP_TEXT_MUTED} ${WISP_SURFACE}
  GetDlgItem $1 $0 1027
  !insertmacro WispStyleControl $1 ${WISP_TEXT} ${WISP_CONTROL}
FunctionEnd
...
Function UpdateResourceDirectoryNotice
  ...
  ${If} ${FileExists} "$ResourceDir\*.*"
    ...
    SetCtlColors $ResourceDirNotice ${WISP_TEXT_SECONDARY} ${WISP_BACKGROUND}
...
Function PageOptions
  ...
  Pop $OptionsDialog
  ${IfThen} $(^RTL) = 1 ${|} nsDialogs::SetRTL $(^RTL) ${|}
  SetCtlColors $OptionsDialog ${WISP_TEXT} ${WISP_BACKGROUND}
  ...
  Pop $InstallDirInput
  !insertmacro WispStyleControl $InstallDirInput ${WISP_TEXT} ${WISP_CONTROL}
  ...
  ${If} $FreshInstall = 1
    ...
    SetCtlColors $ResourceDirLabel ${WISP_TEXT} ${WISP_BACKGROUND}
    ...
    SetCtlColors $ResourceDirDescription ${WISP_TEXT_MUTED} ${WISP_BACKGROUND}
    ...
    !insertmacro WispStyleControl $ResourceDirInput ${WISP_TEXT} ${WISP_CONTROL}
    SendMessage $ResourceDirInput ${WM_SETFONT} $InstallerBodyFont 1

    ${NSD_CreateButton} 79% 94u 21% 14u "$(axlBrowse)"
    Pop $ResourceDirBrowse
    !insertmacro WispStyleControl $ResourceDirBrowse ${WISP_TEXT} ${WISP_CONTROL}
  ...
  ${Else}
    ...
    Pop $0
    SetCtlColors $0 ${WISP_TEXT_MUTED} ${WISP_SURFACE}
    SendMessage $0 ${WM_SETFONT} $InstallerBodyFont 1
  ${EndIf}

  ${NSD_CreateCheckbox} 0 134u 100% 12u "$(createDesktop)"
  Pop $DesktopShortcutCheckbox
  !insertmacro WispStyleControl $DesktopShortcutCheckbox ${WISP_TEXT} ${WISP_BACKGROUND}
  ...
  Pop $OptionsError
  SetCtlColors $OptionsError ${WISP_ERROR} ${WISP_BACKGROUND}
...
Function PageLeaveOptions
  ...
  FileOpen $0 "$ResourceDir\.wisp-write-test" w
  ${If} ${Errors}
    ClearErrors
    ${NSD_SetText} $OptionsError "$(axlResourceDirectoryNotWritable)"
    Abort
  ${EndIf}
  FileWrite $0 "WispLauncher"
  FileClose $0
  Delete "$ResourceDir\.wisp-write-test"
FunctionEnd
...
Function un.ConfirmShow ; Add add a `Delete app data` check box
  ...
  SetCtlColors $1 ${WISP_TEXT} ${WISP_BACKGROUND}
  SetCtlColors $DeleteAppDataCheckbox ${WISP_TEXT} ${WISP_BACKGROUND}
...
LangString axlWelcomeTitle ${LANG_ENGLISH} "Install WispLauncher"
...
LangString axlExistingDirectoryNotice ${LANG_ENGLISH} "This directory already contains files. Wisp will keep them."
...
LangString axlResourceDirectoryNotWritable ${LANG_ENGLISH} " Wisp cannot write to this application directory. Choose another location or change its permissions."
LangString axlFinishTitle ${LANG_ENGLISH} "WispLauncher is installed"
...
LangString axlWelcomeTitle ${LANG_SIMPCHINESE} "安装WispLauncher"
...
LangString axlExistingDirectoryNotice ${LANG_SIMPCHINESE} "此目录中已有文件， Wisp 会保留这些内容。"
...
LangString axlResourceDirectoryNotWritable ${LANG_SIMPCHINESE} " Wisp 无法写入该应用目录，请更换位置或调整目录权限。"
LangString axlFinishTitle ${LANG_SIMPCHINESE} "WispLauncher 已安装"
...
Function .onInit
  ...
  ${AndIf} $PassiveMode <> 1
    ...
    File "/oname=$PLUGINSDIR\WispInstallerUI.exe" "${WISP_INSTALLER_UI_PATH}"
    StrCpy $0 2
    ClearErrors
    ExecWait '"$PLUGINSDIR\WispInstallerUI.exe" --installer "$EXEPATH" --version "${VERSION}" --install-dir "$INSTDIR" --resource-dir "$ResourceDir" --fresh-install "$FreshInstall" --language "$LANGUAGE"' $0
    ${If} $0 <> 2
      Quit
    ${EndIf}
  ${EndIf}
