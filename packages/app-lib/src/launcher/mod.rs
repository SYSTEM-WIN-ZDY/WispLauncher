...
mod offline_skin_resource_pack_tests {
    ...
    fn enables_offline_skin_pack_when_options_file_is_new() {
        ...
        assert_eq!(
            options,
            "resourcePacks:[\"vanilla\",\"file/WispLauncher Offline Skin.zip\"]"
        );
    }
    ...
    fn adds_modern_offline_skin_pack_without_removing_existing_packs() {
        ...
        assert_eq!(
            options,
            "resourcePacks:[\"vanilla\",\"file/user-pack.zip\",\"file/WispLauncher Offline Skin.zip\"]"
        );
    }

    #[test]
    fn removes_both_offline_skin_pack_id_variants() {
        let mut options = "resourcePacks:[\"vanilla\",\"WispLauncher Offline Skin.zip\",\"file/WispLauncher Offline Skin.zip\"]".to_string();
