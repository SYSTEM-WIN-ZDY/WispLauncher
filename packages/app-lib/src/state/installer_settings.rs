...
mod windows {
    ...
    const INSTALLER_REGISTRY_KEY: &str = "Software\\ghs\\WispLauncher";
    ...
    mod tests {
        ...
        fn default_directory() -> PathBuf {
            PathBuf::from(r"C:\Users\Test\AppData\Roaming\red.ghs.wisp")
        }
        ...
        fn applies_a_custom_installer_directory() {
            assert_eq!(
                decide_pending_directory(
                    Some(r"D:\Minecraft\WispLauncher"),
                    &default_directory(),
                    false,
                    false,
                ),
                PendingDirectoryDecision::Apply {
                    custom_dir: r"D:\Minecraft\WispLauncher".to_string(),
        ...
        fn clears_a_default_installer_directory() {
            assert_eq!(
                decide_pending_directory(
                    Some(r"C:\Users\Test\AppData\Roaming\red.ghs.wisp\"),
                    &default_directory(),
                    false,
                    false,
                ),
