...
const CATALOG_SOURCE: &str = "LobeHub 14dfc07b14eee1984e52c195df9319636d6b167b";
...
const PROVIDERS: &[AiProviderDefinition] = &[
    ...
    // scripts/wisp/sync-lobehub-models.mjs. See SPONSORED_PROVIDERS.
    provider!(
        "codeflow",
        "CodeFlow",
        Openai,
...
/// must survive LobeHub model syncing; scripts/wisp/sync-lobehub-models.mjs
...
pub async fn test_provider(
    ...
    complete_text(AiTextRequest {
        ...
        user_prompt: "Hello from WispLauncher".to_string(),
