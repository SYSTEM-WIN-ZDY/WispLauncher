...
pub(crate) const OFFLINE_SKIN_PACK_FILE_NAME: &str = "WispLauncher Offline Skin.zip";
pub(crate) const OFFLINE_SKIN_PACK_LEGACY_ID: &str = "WispLauncher Offline Skin.zip";
pub(crate) const OFFLINE_SKIN_PACK_MODERN_ID: &str =
    "file/WispLauncher Offline Skin.zip";
...
fn build_resource_pack(
    ...
    let metadata = json!({
        "pack": {
            ...
            "description": "WispLauncher offline skin"
        }
    });
